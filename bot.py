		...
		reply_markup=InlineKeyboardMarkup(
			[
				...
				[InlineKeyboardButton("40%", callback_data=f"size_40"), InlineKeyboardButton("45%", callback_data=f"size_45"), InlineKeyboardButton("50%", callback_data=f"size_50"), InlineKeyboardButton("55%", callback_data=f"size_55"), InlineKeyboardButton("60%", callback_data=f"size_60"), .InlineKeyboardButton("65%", callback_data=f"size_65")],
		                [InlineKeyboardButton("70%", callback_data=f"size_70"), InlineKeyboardButton("75%", callback_data=f"size_75"), InlineKeyboardButton("80%", callback_data=f"size_80"), InlineKeyboardButton("85%", callback_data=f"size_85"), InlineKeyboardButton("90%", callback_data=f"size_90"), .InlineKeyboardButton("95%", callback_data=f"size_95")],
                                [InlineKeyboardButton("100%", callback_data=f"size_100")],
